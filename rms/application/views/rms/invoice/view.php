<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Riwayat Pembayaran Invoice <?php echo $invoice->no_invoice; ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active"><a href="#">Invoice</a></li>
            <li class="breadcrumb-item active"><?php echo $invoice->no_invoice; ?></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title mt-2">Riwayat Pembayaran Invoice</h3>
            </div>
            <div class="card-body">
              <table class="table table-striped table-valign-middle">
                <thead>
                  <tr>
                    ...
                    <th class="align-middle">Nomor Invoice</th>
                ...
                <tbody>
                  <?php
                  $no = 0;
                  foreach ($pembayaran_invoice as $row) :
                    $no++; ?>
                    <tr>
                      <td><?php echo $no; ?></td>
