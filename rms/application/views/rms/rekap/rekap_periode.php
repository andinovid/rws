      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="form-horizontal" id="form_kwitansi_supir" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-2">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-primary">Download Rekapitulasi</button>
